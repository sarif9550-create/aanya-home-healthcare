...
export default function AdminPage() {
  ...
  const kpisQ = useQuery({ queryKey: ['kpis'], queryFn: async () => (await axios.get('/api/kpis')).data });
  const leadsQ = useQuery({ queryKey: ['leads'], queryFn: async () => (await axios.get('/api/leads')).data });
  const postsQ = useQuery({ queryKey: ['blog'], queryFn: async () => (await axios.get('/api/blog')).data });
